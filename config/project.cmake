...
#------------------------------------------------------------------------------#
# HDF5 (required by MPAS io)
#------------------------------------------------------------------------------#

# C++ interface can be added with COMPONENTS CXX, but the HDF Group makes no
...
if(FLECSI_SP_ENABLE_MPAS)
  ...
  list(APPEND FLECSI_SP_LIBRARIES ${HDF5_LIBRARIES} ${HDF5_C_HL_LIBRARIES})
endif()
